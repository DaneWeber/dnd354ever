...
See https://mimir.net/creatures/bestiary/rilmani-aurumach for image and description.

## 3.5e Stat Block

From https://www.realmshelps.net/monsters/block/Aurumach_(Rilmani)

```yaml
Creature: Aurumach (Rilmani) (CR 17)
Type: Large Outsider (Extraplanar)
