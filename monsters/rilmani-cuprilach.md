...
See https://mimir.net/creatures/bestiary/rilmani-cuprilach for image and description.

## 3.5e Stat Block

From https://www.realmshelps.net/monsters/block/Cuprilach_(Rilmani)

```yaml
Creature: Cuprilach (Rilmani) (CR 12)
Type: Medium Outsider (Extraplanar)
Alignment: Always neutral
Initiative: +7 (+3 Dex, +4 Improved Initiative)
Senses: Listen +14 and Spot +14
