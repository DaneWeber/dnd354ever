...
// Generated on: 2026-07-04T19:04:57.374Z
...
export const HOMEBREW_SPELLS: Spell[] = [
  ...
  },
  {
    ...
    "savingThrow": "",
    "spellResistance": "",
    "description": "This spell gives you a +10 bonus on caster level checks to overcome the spell resistance of a specific creature. Assay resistance is effective against only one specific creature per casting, and you must be able to see the creature when you cast the spell.",
    "source": "Spell Compendium (SC) Spells",
    "target": "You"
  },
  {
  ...
  },
  {
    ...
    "spellResistance": "Yes",
    "description": "Sound lance causes a projectile of intense sonic energy sound to leap unerringly from you to a target within range. The sound does 1d6 points of sonic damage per caster level, to a maximum of 10d6. The sound lance strikes unerringly, unless the target has total cover or total concealment. A sound lance cannot penetrate the area of a silence spell.",
    "source": "Spell Compendium (SC) Spells",
    "descriptor": "Sonic",
