...
Feeds on Hope. Ingesting causes fixation on death. Vulnerable to good-aligned attacks. 15ft radius aura requires Will save (DC 10 + 2 per size category of the mildew above Fine, thus DC 18 for a Medium size quantity; all mildew in the area is summed for a single save rather than causing multiple saves). Failure induces temporary hopelessness, causing the effects of both the Crushing Despair and Calm Emotions spells.

## Sanguine Lily

Watered with the blood of the innocent. Beautiful scarlet flower. Voluntarily consuming a petal that drops on its own (approximately once per full moon) will sustain you without need for food, makes you immune to disease, and temporarily suspends aging for a month and a day. If you eat a petal once per month (possible with a single lily) you no longer age. A month and two days after last consuming a petal, you begin aging at the rate of a year every day until you reach your natural age or die from old age. Consuming the petals also induces you to murder (Will DC to not murder increases daily until sated, starting at 0 and increasing by 1 each day you do not murder; this process endlessly repeats until no longer under the effects of the lily).

Mercane offered a price indicating it has a 15,000gp market value.
